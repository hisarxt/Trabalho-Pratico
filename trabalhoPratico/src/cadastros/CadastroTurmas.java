...
import java.util.List;
	...
	public void cadastrarTurma(String nome, String codigoDaTurma, String matriculaFubProfessor) {
		...
		Disciplina disciplina = cadastroDisciplina.pesquisarDisciplina(matriculaFubProfessor);	
	...
	public Turma pesquisarTurma(String codigo) {
        for (Turma turma : turmas) {
            if (turma.getCodigoDaTurma().equalsIgnoreCase(codigo)) {
                return turma;
            }
        }
        return null;
	...
	public void alterarTurma(String codigoDaTurma, String novaMatriculaFubProfessor, String novaDisciplinaCodigo) {
